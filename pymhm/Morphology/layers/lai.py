...
from ...project_layout import lai_folder
...
class LaiProcessingMixin(
    ...
    def _write_resampled_lai_netcdf(
        ...
        try:
            ...
            x_centers, y_centers, target_lon, target_lat = self._filled_dem_target_grid(
                filled_dem_layer)
    ...
    def _build_lai_output_dataset(
        ...
        dataset = xr.Dataset(
            ...
            attrs={
                "description": "Long term mean monthly LAI resampled to the filled DEM grid",
