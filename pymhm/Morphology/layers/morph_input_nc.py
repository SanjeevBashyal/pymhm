...
from ..file_tasks import _aligned_l0_window, _dependencies
...
# on purpose: pymhm has no LAI class product yet, so `lai_class_path` is left
...
def write_morph_input_nc(
    ...
    try:
        with Dataset(temporary, "w", format="NETCDF4") as handle:
            ...
            handle.history = "Prepared for mHM by pymhm"
