...
from .pyui.ui_mhm_qgis_dialog_base import Ui_MhmQgisDialog
...
class MhmQgisDialog(QDialog, Ui_MhmQgisDialog, DialogUtils):
    ...
    def connect_signals(self):
        ...
        try:
            self.input_combo("pour_points").layerChanged.connect(
        ...
        run_mhm_button = self.pushButton_execute_mHM
        ...
        terminal_button = self.pushButton_terminal
    ...
    def connect_grid_resolution_signals(self):
        ...
        try:
            self.input_combo("dem").layerChanged.connect(
    ...
    def open_domain_assignment(self, mode):
        ...
        if getattr(sys.modules.get("qgis"), "_mhm_qgis_standalone_qgis", False):
            QMessageBox.information(
                self,
                "Domain Assignment",
