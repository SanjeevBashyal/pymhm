...
class LayerPreparationMixin(DemInputMixin):
    """Generic layer reprojection, clipping, and rasterization helpers."""
    ...
    def process_layer_with_dem_clipping(
        ...
        dem_layer = self.dem_layer if self.dem_layer else self.dialog.input_combo("dem").currentLayer()
