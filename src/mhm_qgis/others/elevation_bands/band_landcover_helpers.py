...
from ...qgis_bridge.morphology.common import math, os, project_geometry_folder
from ...qgis_bridge.morphology.core.base import BaseProcessingMixin
from ...qgis_bridge.morphology.core.naming import NamingAndRangeMixin
...
class BandLandCoverHelperMixin(BaseProcessingMixin, NamingAndRangeMixin):
    ...
    def _ensure_land_use_raster(
        ...
        land_cover_layer = self.dialog.input_combo("land_cover").currentLayer()
