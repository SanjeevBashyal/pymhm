...
from ...qgis_bridge.morphology.common import (
    os,
    project_geometry_folder,
    csv,
)
from ...qgis_bridge.morphology.watershed.watershed_delineation import WatershedDelineationMixin
...
class ElevationBandRasterMixin(
    ...
    def process_elevation_bands(self) -> None:
        ...
        if not dem_layer:
            self.warn("Input Error", "Please select a DEM Raster Layer.")
            return
        ...
        cell_area_m2 = self._reference_cell_area_m2(dem_reference)
