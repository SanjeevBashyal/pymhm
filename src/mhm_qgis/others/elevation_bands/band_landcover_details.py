...
from ...qgis_bridge.morphology.layers.land_cover_class_names import LandCoverClassNameMixin
...
class BandLandCoverDetailsMixin(
    ...
    def process_band_details(self) -> None:
        ...
        cell_area_m2 = self._reference_cell_area_m2(first_band_reference)
