...
class DemFillMixin(DemInputMixin, RasterIOMixin):
    ...
    def fill_dem(self) -> None:
        ...
        original_dem_layer = self.dialog.input_combo("dem").currentLayer()
        ...
        try:
            filled_dem, filled_mask, _invalid = pyflwdir_handler.fill_depressions(
        ...
        pyflwdir_nodata = pyflwdir_handler.NODATA
    ...
    def _existing_filled_dem_matches_current_dem(
        ...
        filled_layer = layers.open_layer(filled_dem_path, "Existing_Filled_DEM")
        if filled_layer is None:
            return False
