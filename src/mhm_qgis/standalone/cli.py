#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Command line interface for mHM QGIS."""
...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        description="mHM QGIS - Python Mesoscale Hydrological Model",
        prog="mhm_qgis"
    )
    ...
    if args.info:
        print("mHM QGIS - Python Mesoscale Hydrological Model")
        print("Version: 0.1.0")
        ...
        print("Homepage: https://github.com/SanjeevBashyal/mhm-qgis")
        return 0

    if args.no_gui:
        print("mHM QGIS CLI installed. Run `mhm_qgis` without --no-gui to open the GUI.")
        return 0
