...
_MARKER = "_mhm_qgis_standalone_qgis"
_RASTER_EXTENSIONS = {
    ".asc",
    ".bil",
    ".grd",
...
def install(force: bool = False) -> bool:
    ...
    try:
        ...
        raise RuntimeError(
            "The standalone mhm_qgis GUI requires PyQt5. Install it with "
            "`pip install mhm_qgis[gui]` or install PyQt5 in this environment."
        ) from exc
    ...
    def _processing_run(name, params):
        raise RuntimeError(
            "QGIS Processing is not available in mhm_qgis standalone mode yet. "
